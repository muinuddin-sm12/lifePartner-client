  ...
  return (
    <div className="p-6 border max-w-2xl mx-auto  rounded-2xl my-10">
      <div className="flex justify-between items-center">
        ...
        <div>
        <button disabled={isDisabled} onClick={handleFavourite} className="py-2 px-5 border rounded-lg">
            {isFavourite ? <FaHeart className="text-lg text-[#E5007D]" /> : <FaRegHeart className="text-lg text-[#E5007D]" />}
          </button>
        </div>
      </div>
      <div className="flex flex-col lg:flex-row gap-4 mt-6 ">
        ...
        <div>
          ...
          <p>Contact Email: {data?.premium}</p>
          <p>Mobile Number: {data?.premium}</p>
        </div>
      </div>
